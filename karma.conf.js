...
module.exports = function (config) {
  // if (!config.package) {
  //   throw new Error("config.package not defined: run <karma start --package=package-name>");
  // }

  // try {
  //   const packageName = require(`./packages/${config.package}/package.json`).name;
  //   console.log("Testing: ", packageName);
  // } catch {
  //   throw new Error(`./packages/${config.package}/package.json not found. Check package name`);
  // }
